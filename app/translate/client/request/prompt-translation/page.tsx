...
export default function PromptTranslationRequestPage() {
  ...
  useEffect(() => {
    const calc = async () => {
      ...
      try {
        ...
        console.error("Failed to calculate amount from prompt translation page", e);
        setBaseAmount(0);
      }
  ...
  const handleSubmit = () => {
    ...
    if (typeof window !== "undefined") {
      window.sessionStorage.setItem("promptTranslationRequest", JSON.stringify(payload));
    }

    alert("(mock) 프롬프트 번역 의뢰가 접수되었습니다. 추후 의뢰 목록/결제로 연결 예정입니다.");
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-6xl mx-auto">
        <header className="mb-6 flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-gray-900 mb-1">프롬프트 번역</h1>
